...
<body>
    <div class="container mt-5">
        ...
        <div class="row">
            <div class="col-md-6">
                <!-- Edit form -->
                <form id="mahasiswa-delete-form" method="DELETE">
                <input type="hidden" class="form-control" id="id" name="id" required value="<?php echo $id; ?>">
                    <div class="form-group">
                        <label for="nim">NIM:</label>
                        <input type="text" class="form-control" id="nim" name="nim" required value="<?php echo $nim; ?>" disabled>
                    </div>
                    <div class="form-group">
                        <label for="nama">Nama:</label>
                        <input type="text" class="form-control" id="nama" name="nama" required value="<?php echo $nama; ?>" disabled>
                    </div>
                    <div class="form-group">
                        <label for="jk">Jenis Kelamin:</label>
                        <input type="text" class="form-control" id="jk" name="jk" required value="<?php echo $jk; ?>" disabled>
                    </div>
                    <div class="form-group">
                        <label for="prodi">Prodi:</label>
                        <input type="text" class="form-control" id="prodi" name="prodi" required value="<?php echo $prodi; ?>" disabled>
                    </div>
